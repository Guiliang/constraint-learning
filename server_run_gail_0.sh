...
python train_gail.py ../config/highD_distance_constraint/train_GAIL_highD_slo_distance_constraint_no_is_bs--1--1_lr-1e-4_mspe-5e1_no-buffer_dm-20_data-1e-1.yaml -n 5 -s 123 -l "$log_dir"
python train_gail.py ../config/highD_distance_constraint/train_GAIL_highD_slo_distance_constraint_no_is_bs--1--1_lr-1e-4_mspe-5e1_no-buffer_dm-20_data-1e-1.yaml -n 5 -s 321 -l "$log_dir"
python train_gail.py ../config/highD_distance_constraint/train_GAIL_highD_slo_distance_constraint_no_is_bs--1--1_lr-1e-4_mspe-5e1_no-buffer_dm-20_data-1e-1.yaml -n 5 -s 666 -l "$log_dir"
cd ../