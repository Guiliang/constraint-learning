...
python train_icrl.py ../config/mujuco_HCWithPos-v0/train_ICRL_HCWithPos-v0_with-action_noise-1e-1.yaml -n 5 -s 123 -l "$log_dir"
python train_icrl.py ../config/mujuco_HCWithPos-v0/train_ICRL_HCWithPos-v0_with-action_noise-1e-1.yaml -n 5 -s 321 -l "$log_dir"
python train_icrl.py ../config/mujuco_HCWithPos-v0/train_ICRL_HCWithPos-v0_with-action_noise-1e-1.yaml -n 5 -s 666 -l "$log_dir"
cd ../