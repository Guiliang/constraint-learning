...
cd ./interface/
nohup python train_icrl.py ../config/mujuco_HCWithPos-v0/train_VICRL_HCWithPos-v0_with_action_with_buffer_p-9e-1-1e-1_clr-5e-3_no_is_CVAR-0.6.yaml -n 5 -l "$log_dir" > nohup.out 2>&1 &
cd ../