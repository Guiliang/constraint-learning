...
cd ./interface/
python generate_data_for_constraint_inference.py -n 5 -mn train_ppo_lag_highD_velocity_penalty_bs--1_fs-5k_nee-10_lr-5e-4_vm-40-multi_env-Sep-19-2022-05:46-seed_123 -tn PPO-Lag-highD-velocity -ct no-over_speed-off_road -l "$log_dir"
