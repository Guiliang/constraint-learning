...
cd ./interface/
python generate_data_for_constraint_inference.py -n 5 -mn train_ppo_lag_highD_velocity_distance_penalty_bs--1_fs-5k_nee-10_lr-5e-4_vm-40_dm-20-multi_env-Aug-14-2022-13:27-seed_123 -tn PPO-Lag-highD-velocity-distance -ct no-too_closed-over_speed-off_road
