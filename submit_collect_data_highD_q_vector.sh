...
cd ./interface/
python generate_data_for_constraint_inference.py -n 5 -mn train_ppo_lag_highD_no_slo_distance_penalty_bs--1_fs-5k_nee-10_lr-5e-4_dm-60-multi_env-Jun-03-2022-11:14-seed_123 -tn PPO-Lag-highD-distance -ct no-too_closed-off_road
