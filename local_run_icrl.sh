...
nohup python train_icrl.py ../config/mujoco_WGW-v0/train_ICRL_WGW-v0_without-action_by_games_max-nu-1_with-buffer-setting1-prob-999e-3.yaml -n 1 -s 123 -l "$log_dir" > nohup_icrl.out 2>&1 &
nohup python train_icrl.py ../config/mujoco_WGW-v0/train_ICRL_WGW-v0_without-action_by_games_max-nu-1_with-buffer-setting1-prob-999e-3.yaml -n 1 -s 321 -l "$log_dir" > nohup_icrl.out 2>&1 &
nohup python train_icrl.py ../config/mujoco_WGW-v0/train_ICRL_WGW-v0_without-action_by_games_max-nu-1_with-buffer-setting1-prob-999e-3.yaml -n 1 -s 666 -l "$log_dir" > nohup_icrl.out 2>&1 &
cd ../