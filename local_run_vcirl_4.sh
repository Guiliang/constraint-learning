...
cd ./interface/
nohup python train_icrl.py ../config/mujoco_AntWall-v0/train_VICRL_AntWall-v0_with-action_no_is_nit-50_p-9e-1-1e-1_VaR-9e-1.yaml -n 5 -s 123 -l "$log_dir" > nohup_4.out 2>&1 &
cd ../