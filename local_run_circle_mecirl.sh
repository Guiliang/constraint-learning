...
#nohup python train_meicrl.py ../config/mujuco_mixture_HCWithPos-v0/train_MEICRL_HCWithPos-v0_cbs-64_lr-5e-5_exp-neg.yaml -s 123 -n 5 -l "$log_dir" > nohup.out 2>&1 &
#process_id=$!
#wait $process_id
#echo shell finish running round $process_id
#nohup python train_meicrl.py ../config/mujuco_mixture_HCWithPos-v0/train_MEICRL_HCWithPos-v0_cbs-64_lr-5e-5_exp-neg_spp.yaml -s 123 -n 5 -l "$log_dir" > nohup.out 2>&1 &
#process_id=$!
#wait $process_id
#echo shell finish running round $process_id
cd ../