...
cd ./interface/
nohup python train_meicrl.py ../config/mujuco_mixture_HCWithPos-v0/train_MEICRL_HCWithPos-v0.yaml -s 123 -n 5 -l "$log_dir" > nohup.out 2>&1 &
#nohup python train_meicrl.py ../config/mujuco_mixture_HCWithPos-v0/train_InfoICRL_HCWithPos-v0.yaml -n 5 -l "$log_dir" > nohup.out 2>&1 &
cd ../