...
python train_icrl.py ../config/highD_velocity_constraint/train_ICRL_highD_velocity_constraint_bs--1-5e2_fs-5k_nee-10_lr-1e-4_mspe-5e-1_no-buffer_vm-40.yaml -n 5 -s 123 -l "$log_dir"
python train_icrl.py ../config/highD_velocity_constraint/train_ICRL_highD_velocity_constraint_bs--1-5e2_fs-5k_nee-10_lr-1e-4_mspe-5e-1_no-buffer_vm-40.yaml -n 5 -s 321 -l "$log_dir"
python train_icrl.py ../config/highD_velocity_constraint/train_ICRL_highD_velocity_constraint_bs--1-5e2_fs-5k_nee-10_lr-1e-4_mspe-5e-1_no-buffer_vm-40.yaml -n 5 -s 666 -l "$log_dir"
cd ../