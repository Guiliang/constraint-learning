...
python train_icrl.py ../config/highD_distance_constraint/train_ICRL_highD_slo_distance_constraint_bs--1-1e3_fs-5k_nee-10_lr-1e-4_mspe-5e1_no-buffer_dm-20_data-1e-1.yaml -n 5 -s 123 -l "$log_dir"
python train_icrl.py ../config/highD_distance_constraint/train_ICRL_highD_slo_distance_constraint_bs--1-1e3_fs-5k_nee-10_lr-1e-4_mspe-5e1_no-buffer_dm-20_data-1e-1.yaml -n 5 -s 321 -l "$log_dir"
python train_icrl.py ../config/highD_distance_constraint/train_ICRL_highD_slo_distance_constraint_bs--1-1e3_fs-5k_nee-10_lr-1e-4_mspe-5e1_no-buffer_dm-20_data-1e-1.yaml -n 5 -s 666 -l "$log_dir"
cd ../