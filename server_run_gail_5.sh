...
python train_gail.py ../config/mujuco_HCWithPos-v0/train_GAIL_HCWithPos-v0_with-action_noise-5e-3.yaml -n 5 -s 123 -l "$log_dir"
python train_gail.py ../config/mujuco_HCWithPos-v0/train_GAIL_HCWithPos-v0_with-action_noise-5e-3.yaml -n 5 -s 321 -l "$log_dir"
python train_gail.py ../config/mujuco_HCWithPos-v0/train_GAIL_HCWithPos-v0_with-action_noise-5e-3.yaml -n 5 -s 666 -l "$log_dir"
cd ../