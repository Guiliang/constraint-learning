...
process_id=$!
wait $process_id
python train_ppo.py ../config/mujoco_WalkerWithPos-v0/train_ppo_WalkerWithPos-v0.yaml -n 5 -s 456 -l "$log_dir"
process_id=$!
wait $process_id
python train_ppo.py ../config/mujoco_WalkerWithPos-v0/train_ppo_WalkerWithPos-v0.yaml -n 5 -s 654 -l "$log_dir"
process_id=$!
wait $process_id
