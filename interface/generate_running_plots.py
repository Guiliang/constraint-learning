...
def generate_plots():
    ...
    #     'VICRL_PendulumWall_VaR-1e-1': 'VCIRL-VaR',
    ...
    method_names_labels_dict = {
        ...
        'VICRL_SwmWithPos-v0_update_b-5e-1_p-90-10_VaR-1e-1': 'VCIRL2',
    ...
    #     "debug-part-train_VICRL_highD_velocity_constraint_p-9e-1-1e-1_no_is_bs--1-5e2_fs-5k_nee-10_lr-1e-4_no-buffer_vm-40": "VCIRL5",
