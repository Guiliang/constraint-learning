...
cd ./interface
python train_icrl.py ../config/mujoco_InvertedPendulumWall-v0/train_VICRL_InvertedPendulumWall-v0_prl-1e-2_p-9e-2-1e-2_mode-mean.yaml -n 5 -s 123 -l "$log_dir"
process_id=$!
wait $process_id
